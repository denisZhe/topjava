...
public class Meal extends BaseEntity {
    ...
    @NotNull(groups = {View.ValidatedUI.class, Default.class, View.ValidatedREST.class})
    @JsonView(View.JsonREST.class)
    private LocalDateTime dateTime;

    @Column(name = "description", nullable = false)
    @NotBlank(groups = {View.ValidatedUI.class, Default.class, View.ValidatedREST.class})
    private String description;

    @Column(name = "calories", nullable = false)
    @Range(min = 10, max = 5000, groups = {View.ValidatedUI.class, Default.class, View.ValidatedREST.class})
    @NotNull(groups = {View.ValidatedUI.class, Default.class, View.ValidatedREST.class})
